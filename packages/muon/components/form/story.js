...
const innerDetail = () => `
<form>
  <${prefix}-inputter helper="Useful information to help populate this field." validation='["isRequired"]' name="username">
    <label slot="label">Name</label>
    <input type="text" placeholder="e.g. Placeholder" name="username"/>
  </${prefix}-inputter>

  <${prefix}-inputter value="" helper="How can we help you?" validation="[&quot;isRequired&quot;,&quot;isEmail&quot;]" autocomplete="email">
  ...
  <${prefix}-inputter heading="What options do you like?" helper="How can we help you?" validation='["isRequired"]' value="b">
  ...
  <input type="reset" />
  <${prefix}-cta type="submit">Submit</${prefix}-cta>
<form>`;
